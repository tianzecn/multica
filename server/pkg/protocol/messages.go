...
const (
	DaemonProjectWorkspaceMaxFrameBytes = 4 * 1024 * 1024
...
type ChatSessionUpdatedPayload struct {
	...
	// HasUnread is set only by the explicit mark-unread path. Other updates
	// leave the cached unread state untouched.
