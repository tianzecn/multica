		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/projects", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Get("/workspace/bindings/{deviceId}/git/diff", h.RelayProjectWorkspaceGitDiff)
					r.Get("/workspace/bindings/{deviceId}/git/log", h.RelayProjectWorkspaceGitLog)
					r.Get("/workspace/bindings/{deviceId}/git/snapshots", h.RelayProjectWorkspaceGitSnapshots)
					r.Post("/workspace/bindings/{deviceId}/git/{operation}", h.RelayProjectWorkspaceGitOperation)
					r.Get("/workspace/bindings/{deviceId}/files/tree", h.RelayProjectWorkspaceFileTree)
					r.Get("/workspace/bindings/{deviceId}/files/read", h.RelayProjectWorkspaceFileRead)
					r.Put("/workspace/bindings/{deviceId}/files/write", h.RelayProjectWorkspaceFileWrite)
					r.Get("/workspace/bindings/{deviceId}/scripts", h.RelayProjectWorkspaceScripts)
					r.Post("/workspace/bindings/{deviceId}/scripts/run", h.RelayProjectWorkspaceRunScript)
					r.Post("/workspace/bindings/{deviceId}/scripts/{runId}/stop", h.RelayProjectWorkspaceStopScript)
					r.Get("/workspace/bindings/{deviceId}/terminal", h.RelayProjectWorkspaceTerminals)
					r.Post("/workspace/bindings/{deviceId}/terminal/start", h.RelayProjectWorkspaceStartTerminal)
					r.Post("/workspace/bindings/{deviceId}/terminal/{sessionId}/input", h.RelayProjectWorkspaceTerminalInput)
					r.Post("/workspace/bindings/{deviceId}/terminal/{sessionId}/stop", h.RelayProjectWorkspaceStopTerminal)
				})
			})
			...
			r.Route("/api/channels", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Delete("/permanent", h.DeleteArchivedChannel)
					...
					r.Get("/plans/{planId}", h.GetChannelDispatchPlan)
					r.Post("/plans/{planId}/cancel", h.CancelChannelDispatchPlan)
					r.Post("/plans/{planId}/add-agent", h.AddAgentToChannelDispatchPlan)
					r.Post("/plans/{planId}/change-mode", h.ChangeChannelDispatchPlanMode)
					r.Post("/plans/{planId}/steps/{stepId}/retry", h.RetryChannelDispatchStep)
					r.Post("/plans/{planId}/steps/{stepId}/skip", h.SkipChannelDispatchStep)
					r.Delete("/sessions/{sessionId}", h.ArchiveChannelSession)
					r.Post("/sessions/{sessionId}/restore", h.RestoreChannelSession)
					r.Get("/sessions/{sessionId}/agent-runs", h.ListChannelAgentRuns)
					r.Get("/sessions/{sessionId}/plans", h.ListChannelDispatchPlans)
			...
			r.Route("/api/chat/sessions", func(r chi.Router) {
				...
				r.Route("/{sessionId}", func(r chi.Router) {
					...
					r.Post("/restore", h.RestoreChatSession)
					r.Post("/messages", h.SendChatMessage)
					r.Get("/messages", h.ListChatMessages)
					r.Get("/pending-task", h.GetPendingChatTask)
					r.Post("/read", h.MarkChatSessionRead)
					r.Post("/unread", h.MarkChatSessionUnread)
				})
			})
