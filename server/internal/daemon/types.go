...
type Task struct {
	...
	ProjectVerificationCommands []string              `json:"project_verification_commands,omitempty"`
	ProjectContinueOnDirty      bool                  `json:"project_continue_on_dirty,omitempty"` // explicit user consent to safety-snapshot dirty worktree before agent work
