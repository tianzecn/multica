...
type Task struct {
	...
	ProjectBaseBranch             string                 `json:"project_base_branch,omitempty"`              // project workspace base branch; defaults to main when empty
	ProjectScopePath              string                 `json:"project_scope_path,omitempty"`               // optional monorepo scope path within the project Git root
	ProjectVerificationCommands   []string               `json:"project_verification_commands,omitempty"`    // project-specific verification commands
	ProjectContinueOnDirty        bool                   `json:"project_continue_on_dirty,omitempty"`        // explicit consent to snapshot a dirty project workspace before execution
