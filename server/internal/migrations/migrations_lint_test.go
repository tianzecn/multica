...
var legacyDuplicateMigrationStems = map[string][]string{
	...
	"108": {"108_channels", "108_task_token"},
	"109": {"109_agent_task_waiting_local_directory", "109_channel_agent_threads", "109_drop_agent_skills_local", "109_issue_pull_request_close_intent", "109_lark_integration"},
	"110": {"110_autopilot_trigger_event_filters", "110_channel_dispatch_plans"},
	"111": {"111_attachment_channel_columns", "111_issue_origin_lark_chat", "111_workspace_avatar"},
	"112": {"112_channel_mention_issue_search", "112_issue_dates_to_date", "112_lark_installation_bot_union_id"},
	"113": {"113_channel_project_ownership", "113_lark_inbound_dedup_per_installation", "113_sys_cron_executions"},
	"114": {"114_agent_task_queue_running_started_at_index", "114_project_conversations"},
	"115": {"115_agent_runtime_last_seen_at_index", "115_project_repo_roles"},
	"116": {"116_lark_installation_region", "116_project_workspace_bindings"},
	"117": {"117_agent_task_queue_initiator_user_id", "117_project_pull_requests"},
