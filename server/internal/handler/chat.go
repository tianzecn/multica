...
func (h *Handler) SendChatMessage(w http.ResponseWriter, r *http.Request) {
	...
	sent, err := h.TaskService.SendDirectChatMessage(
		r.Context(), session, agent, parseUUID(userID), req.Content,
		attachmentIDs, actorType, parseUUID(actorID),
		service.EnqueueChatTaskOptions{ProjectContinueOnDirty: req.ProjectContinueOnDirty},
	)
	if err != nil {
