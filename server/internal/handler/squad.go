...
func (h *Handler) enqueueSquadLeaderTask(ctx context.Context, issue db.Issue, triggerCommentID pgtype.UUID, authorType, authorID string, opts ...service.EnqueueIssueTaskOptions) {
	...
	if _, err := h.TaskService.EnqueueTaskForSquadLeaderWithOptions(ctx, issue, squad.LeaderID, triggerCommentID, taskOpts); err != nil {
