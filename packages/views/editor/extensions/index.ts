...
export interface EditorExtensionsOptions {
  ...
  getScopedMentionItems?: () => MentionItem[] | undefined;
  getMentionSearchIssues?: () => boolean;
  getMentionIssueProjectId?: () => string | null;
        ...
        : options.queryClient
          ? {
              suggestion: createMentionSuggestion(options.queryClient, {
                ...
                getScopedItems: options.getScopedMentionItems,
                getSearchIssues: options.getMentionSearchIssues,
                getIssueProjectId: options.getMentionIssueProjectId,
              }),
            }
          : {}),
    }),
