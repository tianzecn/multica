...
interface ContentEditorBaseProps {
  ...
  /** Restrict mention suggestions to these actors when provided. */
  mentionItems?: MentionItem[];
  /** Whether issue results are included for a scoped mention list. Defaults true. */
  mentionSearchIssues?: boolean;
  /** Optional project scope for issue mention search. */
...
const ContentEditor = forwardRef<ContentEditorRef, ContentEditorProps>(
  function ContentEditor(
    ...
    const mentionItemsRef = useRef<MentionItem[] | undefined>(mentionItems);
    const mentionSearchIssuesRef = useRef(mentionSearchIssues);
    const mentionIssueProjectIdRef = useRef<string | null>(mentionIssueProjectId);
    ...
    const editor = useEditor({
      ...
      extensions: createEditorExtensions({
        ...
        getScopedMentionItems: () => mentionItemsRef.current,
        getMentionSearchIssues: () => mentionSearchIssuesRef.current,
        getMentionIssueProjectId: () => mentionIssueProjectIdRef.current,
        enableSlashCommands,
        slashCommandMode,
        quickActionMenu: {
