...
describe("CreateProjectModal", () => {
  ...
  it("filters workspace repositories by search text", async () => {
    ...
    expect(screen.getAllByRole("tooltip", { name: apiRepoUrl }).length).toBeGreaterThan(0);
    expect(screen.queryByRole("tooltip", { name: webRepoUrl })).not.toBeInTheDocument();
    expect(screen.queryByRole("tooltip", { name: longRepoUrl })).not.toBeInTheDocument();
